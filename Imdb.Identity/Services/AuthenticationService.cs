...
namespace Imdb.Identity.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<AuthenticationResponse> AuthenticateAsync(AuthenticationRequest request)
        {
            ...
            if (user == null)
            {
                throw new DomainException($"User with {request.Email} not found.");
            }
            ...
            if (!result.Succeeded)
            {
                throw new DomainException($"Credentials for '{request.Email} aren't valid'.");
            }
        ...
        private async Task<JwtSecurityToken> GenerateToken(ApplicationUser user)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: _dateTimeProvider.Now().AddMinutes(_jwtSettings.DurationInMinutes),
